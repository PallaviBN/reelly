  ...
  return (
    <div className="w-screen">
      <iframe
        ...
        src={`https://www.youtube.com/embed/${featuredMovieTrailer?.key}?si=nZLq1uJMBPznnyfN?playlist=${featuredMovieTrailer?.key}&loop=1&amp;start=5&autoplay=1&mute=1&loop=1`}
