...
const WatchList = () => {
  ...
  return (
    <div><header className="w-screen flex align-middle py-2 z-10 shadow-none bg-gradient-to-br from-black px-4 justify-center md:justify-between">
    <Link to="/browse">
      <img
  ...
  <h1 className="ml-16 p-8 pt-10 pb-6 text-white font-bold text-xl">WatchList »</h1>
      <div className="mt-5">
        {watchList.length ? (
        ...
        ): <span className="flex justify-center items-center ml-16 p-8 pt-10 pb-6 text-white font-medium text-base ">Nothing in the WatchList yet!!</span>}
      </div>
    </div>
  )
}
